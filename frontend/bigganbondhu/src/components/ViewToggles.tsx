...
const ViewToggles: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="flex gap-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-2 rounded-lg shadow-lg border border-indigo-100 dark:border-indigo-900"
    >
      <button
        ref={orbitButtonRef}
        className={`px-4 py-2 rounded-md font-semibold transition-all duration-300 flex items-center ${
          viewMode === "orbit"
